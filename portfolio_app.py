...
# ====================== GLOBAL CSS (STRONG LIGHT + DARK THEME SUPPORT) ======================
st.markdown("""
<style>
    ...
    /* Glossy cards & headers - FULL light/dark support */
    ...
    /* Dark theme defaults */
    .glossy-header, .glossy-box { background: #1e2a44; }
    .glossy-box > div:first-child { color: #e0e0e0; }
    .glossy-box > div:last-child { color: #ffffff; }

    /* Light theme overrides - VERY STRONG */
